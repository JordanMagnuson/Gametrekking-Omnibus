package freedombridge  
{
	...
	public class Player extends Moveable
	{
		 ...
		 * Player graphic
		 */
		[Embed(source = '../../assets/freedombridge/player.png')] private const S_PLAYER:Class;
		public var image:Image = new Image(S_PLAYER);
		public var bloodCanvas:Canvas = new Canvas(MyWorld.width, MyWorld.height);		
		
		[Embed(source = '../../assets/freedombridge/splat.png')] private const S_SPLAT:Class;
		public var splatImage:Image = new Image(S_SPLAT);		
		
		/**
		 * Gunshot sound
		 */
		[Embed(source = '../../assets/freedombridge/gunshot.mp3')] private const SND_GUN:Class;
		//[Embed(source = '../../assets/freedombridge/gunshot_new.swf', symbol = 'DarkoZL__Barret50_amp.wav')] private const SND_GUN:Class;
		...
		{
			// render blood
			bloodCanvas.render(FP.buffer, FP.zero, FP.camera);
