package gallery 
{
	...
	public class Assets 
	{
		...
		public static const KOREA_PHOTO_ARRAY:Array = new Array(
			new Array(korea_01, "Some of the middle school students I taught for a year in the Korean countryside. Empathy for the social isolation that some of them felt inspired me to create the short interactive sketch, 'Loneliness.'"),
			...
			new Array(korea_09, "Boys playing baseball in Gunsan. One of Korea's favorite sports, and a legacy of America's part in the Korean War."),
			new Array(korea_05, "A picture I shot on a trip to Jeonju... though the sight of piled shoes is so common in Korea, that this might as well be anywhere in the country."),
