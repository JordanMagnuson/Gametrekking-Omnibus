package killer.game 
{
	...
	public class Explosion extends Entity
	{
		...
		[Embed(source='../../../assets/killer/explosion.png')] private const SPRITE:Class;
		public var spritemap:Spritemap = new Spritemap(SPRITE, 64, 64);	
		
		[Embed(source = '../../../assets/killer/explosion.swf', symbol = 'explosion_01.wav')] private const SND_EXPLODE:Class;
