package killer.game
{
	...
	public class Victim extends Entity
	{
		 ...
		 * Graphic
		 */
		[Embed(source='../../../assets/killer/victim.png')] private const VICTIM:Class;
		public var spritemap:Spritemap = new Spritemap(VICTIM, 20, 20);	
		
		/**
		 * Sound
		 */
		[Embed(source = '../../../assets/killer/killer_sounds.swf', symbol = 'walk_fast_15562_modified.wav')] private const SND_WALK_FAST:Class;
