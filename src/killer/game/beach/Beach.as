package killer.game.beach 
{
	...
	import killer.game.*;
	import killer.game.desert.Cactus;
	import killer.game.forest.ForestPalm;
	import net.flashpunk.Entity;
	import net.flashpunk.FP;
	import killer.game.Player;
	...
	{		
		 ...
		 * Sound
		 */
		[Embed(source='../../../../assets/killer/sounds.swf', symbol='waves_ambient.wav')] private const DAY_SOUND:Class;
		[Embed(source='../../../../assets/killer/sounds.swf', symbol='waves_ambient.wav')] private const NIGHT_SOUND:Class;
		
		[Embed(source='../../../../assets/killer/sounds.swf', symbol='wind_burst.wav')] private const SND_WIND:Class;
		public var sndWind:Sfx = new Sfx(SND_WIND);				
		
		[Embed(source='../../../../assets/killer/sounds.swf', symbol='gulls_01.wav')] private const SND_GULLS01:Class;
		public var sndGulls01:Sfx = new Sfx(SND_GULLS01);	
		[Embed(source='../../../../assets/killer/sounds.swf', symbol='gulls_02.wav')] private const SND_GULLS02:Class;
		public var sndGulls02:Sfx = new Sfx(SND_GULLS02);	
		[Embed(source='../../../../assets/killer/sounds.swf', symbol='gulls_03.wav')] private const SND_GULLS03:Class;
