package killer.game.forest 
{
	...
	{	
		 ...
		 * Sound
		 */
		[Embed(source='../../../../assets/killer/sounds.swf', symbol='forest_ambient')] private const DAY_SOUND:Class;
		[Embed(source='../../../../assets/killer/sounds.swf', symbol='forest_night_ambient')] private const NIGHT_SOUND:Class;
		
		[Embed(source='../../../../assets/killer/sounds.swf', symbol='owl.wav')] private const SND_OWL:Class;
		public var sndOwl:Sfx = new Sfx(SND_OWL);
		
		[Embed(source='../../../../assets/killer/sounds.swf', symbol='wolf.wav')] private const SND_WOLF:Class;
		public var sndWolf:Sfx = new Sfx(SND_WOLF);
		
		[Embed(source='../../../../assets/killer/sounds.swf', symbol='creaking.wav')] private const SND_CREAKING:Class;
