package killer.game.jungle 
{
	...
	public class Jungle extends Location
	{
		 ...
		 * Sound
		 */
		//[Embed(source='../../../../assets/killer/jungle_sounds.swf', symbol='jungle_night_loop_106973.wav')] private const NIGHT_SOUND:Class;	
		//[Embed(source='../../../../assets/killer/jungle_sounds.swf', symbol='jungle_day_1_minute_34348.wav')] private const DAY_SOUND:Class;
		
		[Embed(source='../../../../assets/killer/jungle_sounds.swf', symbol='jungle_day_1_minute_34348.wav')] private const DAY_SOUND:Class;
		[Embed(source='../../../../assets/killer/jungle_sounds.swf', symbol='jungle_night_106973.wav')] private const NIGHT_SOUND:Class;
		
		[Embed(source='../../../../assets/killer/sounds.swf', symbol='cicadas.wav')] private const SND_CICADAS:Class;
		public var sndCicadas:Sfx = new Sfx(SND_CICADAS);			
		
		[Embed(source='../../../../assets/killer/jungle_sounds.swf', symbol='kookaburra')] private const SND_KOOKA:Class;
		public var sndKooka:Sfx = new Sfx(SND_KOOKA);					
		
		[Embed(source='../../../../assets/killer/jungle_sounds.swf', symbol='little_parot')] private const SND_PARROT:Class;
		public var sndParrot:Sfx = new Sfx(SND_PARROT);			
		
		[Embed(source='../../../../assets/killer/jungle_sounds.swf', symbol='macaw')] private const SND_MACAW:Class;
		public var sndMacaw:Sfx = new Sfx(SND_MACAW);		
		
		[Embed(source='../../../../assets/killer/jungle_sounds.swf', symbol='monkey')] private const SND_MONKEY:Class;
