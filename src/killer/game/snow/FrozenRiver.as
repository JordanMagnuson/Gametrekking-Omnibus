package killer.game.snow
{
	...
	{	
		 ...
		 * Graphics
		 */
		[Embed(source = '../../../../assets/killer/snow/frozen_river.png')] private const SPRITE01:Class;			
		
		/**
		 * Sound
		 */
		[Embed(source='../../../../assets/killer/sounds.swf', symbol='ice_creaking')] private const SND_CREAKING:Class;
