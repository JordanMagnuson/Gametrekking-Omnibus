package killer.game.snow 
{
	...
	{		
		 ...
		 * Sound
		 */
		[Embed(source='../../../../assets/killer/sounds.swf', symbol='wind_ambient')] private const DAY_SOUND:Class;
		[Embed(source = '../../../../assets/killer/sounds.swf', symbol = 'wind_ambient')] private const NIGHT_SOUND:Class;
