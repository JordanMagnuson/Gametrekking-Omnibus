package kindnessofstrangers
{
	...
	public class Preloader extends MovieClip 
	{
		...
		// Font
		[Embed(source = '../../assets/kindnessofstrangers/fonts/verdana.ttf', embedAsCFF="false", fontFamily = 'verdana')] private var Verdana:Class;
		
		// Backdrop
		[Embed(source='../../assets/kindnessofstrangers/loading_background.png')] static private var imgBackground:Class;
		private var backdrop:Bitmap = new imgBackground;			
		
		// Click to continue
		[Embed(source='../../assets/kindnessofstrangers/click_to_continue.png')] static private var imgClick:Class;
