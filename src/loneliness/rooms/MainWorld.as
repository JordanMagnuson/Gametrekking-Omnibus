package loneliness.rooms 
{
	...
	public class MainWorld extends World
	{
		 ...
		 * Sound
		 */
		[Embed(source='../../../assets/loneliness/sound/Sounds.swf', symbol='blue_paint_loop.mp3')] private const MUSIC:Class;
		...
		public function updateBackground():void
		{
			...
			if (player.y > 12000) 
			{
				if (classCount(Background01) == 0) add(bg01);
			}
			else 
			{
			...
			if (player.y > 10000) 
			{
				if (classCount(Background02) == 0) add(bg02);
			}
			else 
			{
