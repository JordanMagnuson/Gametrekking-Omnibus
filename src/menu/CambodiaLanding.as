package menu 
{
	...
	public class CambodiaLanding extends MenuLanding
	{
		...
		public var reflectionURL:String = "http://www.gametrekking.com/blog/cambodia-like-no-place-ive-been?utm_source=airapp&utm_medium=desktop&utm_campaign=gametrekkingomnibus";	
		public var morePhotosURL:String = "http://www.gametrekking.com/blog/cambodia-journey-in-review?utm_source=airapp&utm_medium=desktop&utm_campaign=gametrekkingomnibus";
		...
		{
			var goto:World = new Reflection(Assets.CAMBODIA_REFLECTION, CambodiaLanding);
			Transition.to(goto, new Global.TRANS_OUT(Global.TRANS_OUT_OPTIONS), new Global.TRANS_IN(Global.TRANS_IN_OPTIONS)); 					
